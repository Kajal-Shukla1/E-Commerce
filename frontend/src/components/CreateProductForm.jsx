...
const categories = ["jeans","t-shirts","shoes","jackets","sweaters","glasses","bags","hats"]
...
const CreateProductForm = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.readAsDataURL(file); //base64 encode the image
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div>
            ...
            <input
              ...
              className='mt-1 block w-full border-gray-600  bg-gray-700 rounded-md shadow-sm py-2 px-3 
