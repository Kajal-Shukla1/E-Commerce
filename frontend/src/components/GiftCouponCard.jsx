    ...
    >
        <div className="space-y-4">
            <div>
                ...
                <input id='voucher' type='text' value={userInputCode} placeholder="Enter Code here"
                ...
                onChange={(e) => setUserInputCode(e.target.value)} required/>
            </div>
        ...
        {isCouponApplied && coupon && (
            <div className="mt-4">
                ...
                <motion.button
                  type='button'
                  className='mt-2 flex w-full items-center justify-center rounded-lg bg-red-600 px-5 py-2.5 text-sm
                  font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300'
                  whileHover={{scale:1.05}}
                  whileTap={{scale:0.95}}
